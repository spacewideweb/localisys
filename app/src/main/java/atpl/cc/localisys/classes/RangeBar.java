...
public class RangeBar extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mIsRangeBar) {
            ...
            mLeftThumb.setFormatter((atpl.cc.localisys.classes.IRangeBarFormatter) mFormatter);
        ...
        mRightThumb.setFormatter((atpl.cc.localisys.classes.IRangeBarFormatter) mFormatter);
